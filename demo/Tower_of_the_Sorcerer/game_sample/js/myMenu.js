var MyMenu = Framework.exClass(Framework.GameMainMenu, {
  ...
  draw: function (parentCtx) {
    ...
    parentCtx.fillRect(this.rectPosition.x, this.rectPosition.y, 300, 100); //框的大小
    parentCtx.fillRect(
      this.rectPosition.x - 250,
      this.rectPosition.y + 240,
      300,
      100
    ); //框的大小
    parentCtx.fillRect(
    ...
    parentCtx.fillText(
      "Click To Start",
      this.rectPosition.x + 150,
      this.rectPosition.y + 10,
      260
    );
    parentCtx.fillText(
      "About",
  ...
  mousedown: function (e) {
    ...
    if (e.x >= 418 && e.x <= 720 && e.y >= 688 && e.y <= 791) {
      ...
      Framework.Game.goToLevel("myAbout");
      console.log("is About");
    } else if (e.x >= 669 && e.x <= 968 && e.y >= 447 && e.y <= 546) {
      Framework.Game.goToLevel("genderMenu");
