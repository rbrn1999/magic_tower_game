var Bat = function (file, position) {  //畫面的object
    ...
    this.smallBat = new Framework.AnimationSprite({ url: define.imagePath + 'e5.png', col: 2, row: 1, loop: true, speed: 1 });
    this.smallBat.scale = 2;
    this.smallBat.index = 1;

    this.bigBat = new Framework.AnimationSprite({ url: define.imagePath + 'e6.png', col: 2, row: 1, loop: true, speed: 1 });
    this.bigBat.scale = 2;
    this.bigBat.index = 1;
